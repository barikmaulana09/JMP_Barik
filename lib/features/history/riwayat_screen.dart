...
class _RiwayatScreenState extends State<RiwayatScreen> {
  ...
  List<SurveyRecordModel> get _filteredSurveys {
    if (_searchQuery.isEmpty) return _surveys;
            ...
            child: Column(
              ...
              children: [
                ...
                ListTile(
                  ...
                  subtitle: Text(DateFormatter.toDisplay(DateFormatter.toDb(tanggal))),
                  onTap: () async {
                    ...
                    if (picked != null) setLocalState(() => tanggal = picked);
                  },
                ),
  ...
  Widget _buildEmptyState() {
    return ListView(
      ...
      children: [
        ...
        Icon(
          _searchQuery.isEmpty ? Icons.history_toggle_off_rounded : Icons.search_off_rounded,
          size: 80,
        ...
        child: ListTile(
          ...
          subtitle: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Icon(Icons.calendar_today, size: 12, color: AppTheme.textSecondary.withValues(alpha: 0.6)),
                  ...
                  Icon(Icons.person_outline, size: 12, color: AppTheme.textSecondary.withValues(alpha: 0.6)),
                  const SizedBox(width: 4),
                  Text(
                    survey.namaPetugas ?? '-',
                    style: TextStyle(fontSize: 12, color: AppTheme.textSecondary.withValues(alpha: 0.8)),
